...
| [no-only-test](docs/rules/no-only-test.md)                                                                                                                                                                       | ✅  |    |    |    | 💡 |    |s/rules/no-todo-implementation.md)       | Disallow giving `test.todo()` an implementation function.                                                      | ✅  |    |    |    | 💡 |    |
...
| [prefer-power-assert](docs/rules/prefer-power-assert.md)             | Enforce using only assertions compatible with [power-assert](                                                        | ✅  |    |    |    |    |    |
